    ...
    def on_step_begin(self, step, logs):
        if self.step % self.interval == 0:
            if len(self.episode_rewards) > 0:
                ...
                string = str(self.step // self.interval )+" "+str(len(self.episode_rewards))+" "+str(np.mean(self.episode_rewards))+" "+str(np.min(self.episode_rewards))+" "+str(np.max(self.episode_rewards))+" "+str(self.step)+" "+str(pointer[1000009])+" "+str(pointer[1000010])+" "+str(pointer[1000011])+" "+str(pointer[1000013])+"\n"
